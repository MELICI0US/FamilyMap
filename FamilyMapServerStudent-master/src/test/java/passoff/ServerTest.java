...
public class ServerTest {
    ...
    public void testWrongUserPerson(TestInfo testInfo) {
        printTestName(testInfo);
        //We are calling the load api using the data in "/passoffFiles/LoadedData.json" as the request
        load();
        try {
            //We are calling the login api for a user named sheila
    ...
    public void testValidEvent(TestInfo testInfo) {
        ...
        load();
        try {
            //We are creating a JsonReader from the LoadedData.json file
            JsonReader jsonReader = new JsonReader(new FileReader("passoffFiles/LoadedData.json"));
            ...
            Assertions.fail("passoffFiles/LoadedData.json not found in project root directory");
        }
    }
    ...
    /**
     * Uses the LoadedData.json file to create information in the database which
     ...
     * request would contain the information listed in LoadedData.json.
     */
    private void load() {
        try {
            JsonReader jsonReader = new JsonReader(new FileReader("passoffFiles/LoadedData.json"));
